...
export default function CustomerUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setOutstanding_amount(cleanValues.outstanding_amount);
    setBilling_address(cleanValues.billing_address);
    setCustomer_status(cleanValues.customer_status);
    ...
    setCredit_limit(cleanValues.credit_limit);
    setNote(cleanValues.note);
    setPrintColor(cleanValues.printColor);
    setErrors({});
  };
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          email: email ?? null,
          phone: phone ?? null,
          outstanding_amount: outstanding_amount ?? null,
