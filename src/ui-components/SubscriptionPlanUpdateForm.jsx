...
import { getSubscriptionPlan } from "../graphql/queries";
import { updateSubscriptionPlan } from "../graphql/mutations";
      ...
      const record = idProp
        ? (
            await client.graphql({
              query: getSubscriptionPlan.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getSubscriptionPlan
        : subscriptionPlanModelProp;
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateSubscriptionPlan.replaceAll("__typename", ""),
            variables: {
              input: {
