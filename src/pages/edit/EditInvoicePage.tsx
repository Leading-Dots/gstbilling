...
import { addInvoice, editInvoice, getInvoiceById } from "@/db/Invoices";
...
export default function EditInvoicePage() {
  ...
  const fetchInvoiceData = async () => {
    try {
      ...
      if (invoiceData) {
        ...
        form.setValue("invoiceDate", new Date(invoiceData.invoice_date));
        form.setValue("dueDate", new Date(invoiceData.due_date));
        form.setValue("fromCompany", invoiceData.from_company);
        form.setValue("fromAddress", invoiceData.from_address);
        form.setValue("fromGstin", invoiceData.from_gstin);
        form.setValue("fromEmail", invoiceData.from_email);
        form.setValue("fromPhone", invoiceData.from_phone);
        form.setValue("toCustomer", invoiceData.to_customer);
        form.setValue("toAddress", invoiceData.to_address);
        form.setValue("toGstin", invoiceData.to_gstin);
        form.setValue("toEmail", invoiceData.to_email);
        form.setValue("toPhone", invoiceData.to_phone);
        form.setValue("items", parsedItems);
        form.setValue("subtotal", Number(invoiceData.subtotal));
        form.setValue("cgst", Number(invoiceData.cgst));
        form.setValue("sgst", Number(invoiceData.sgst));
        form.setValue("igst", Number(invoiceData.igst));
        form.setValue("total", Number(invoiceData.total));
        form.setValue("notes", invoiceData.notes);
        form.setValue("termsAndConditions", invoiceData.terms_conditions);
        form.setValue("invoiceStatus", invoiceData.invoice_status);
      }
    } catch (error) {
  ...
  const onSubmit = async (data: InvoiceFormValues) => {
    ...
    try {
      const newInvoice = await editInvoice({
        id: params.id!!,
